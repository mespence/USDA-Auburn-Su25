...
class SettingsWindow(QWidget):
    ...
    def delete_label_dialog(self):
        ...
        if result == QMessageBox.StandardButton.No:
            return
        try:
            Settings.label_colors['light'].pop(label)
            Settings.label_colors['dark'].pop(label)
    ...
    #     color = QColor(r, g, b)
    #     color.setAlpha(Settings.alpha)
    #     if label in Settings.label_colors or label in Settings.labels_to_show:
    #         msg = QMessageBox(self)
    #         msg.setWindowTitle("Add label")
    ...
    def save_settings(self):
        ...
        self.settings.setValue('accent_color', Settings.accent_color_name)
        ...
        for label, colors in Settings.label_colors.items():
            self.settings.setValue(f"label_colors/{label}/light", colors['LIGHT'])
            self.settings.setValue(f"label_colors/{label}/dark", colors['DARK'])

        self.settings.setValue("dataline_color", Settings.data_line_color.name())

        self.settings.setValue("show_h_grid", Settings.show_h_grid)
        self.settings.setValue("show_v_grid", Settings.show_v_grid)
        self.settings.setValue("show_labels", Settings.show_labels)
        self.settings.setValue("show_durations", Settings.show_durations)
