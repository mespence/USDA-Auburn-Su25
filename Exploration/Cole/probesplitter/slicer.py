...
def read_file(file_path, desired = None, save_dir=None):
    ...
    if "labels" in df_copy.columns and desired is not None:
        if desired == "p":
            df_copy = df_copy[~df_copy["labels"].isin(["N", "Z"])]
        if desired == "np":
            df_copy = df_copy[df_copy["labels"].isin(["N", "Z"])]
...
if __name__ == "__main__":
    ...
    save_dir_1 = r"/Users/cathy/coding/bugs2025/USDA-Auburn-Su25/Exploration/Cole/probesplitter/gooddata_sliced_p"
    save_dir_2 = r"/Users/cathy/coding/bugs2025/USDA-Auburn-Su25/Exploration/Cole/probesplitter/gooddata_sliced_np"
    probes = []
