...
def read_file(file_path, save_dir=None):
    ...
    if "labels" in df_copy.columns:
        df_copy["labels"] = df_copy["labels"].replace({"N": "NP", "Z": "NP"})
        df_copy.loc[df_copy["labels"] != "NP", "labels"] = "P"
    ...
    if save_dir is not None:
        ...
        if file_path.endswith(".csv"):
            ...
            df_copy.to_parquet(save_path, index=False)
    return df_copy

if __name__ == "__main__":
    data_dir = r"/Users/cathy/coding/bugs2025/USDA-Auburn-Su25/Exploration/Cole/probesplitter/gooddata"
    save_dir = r"/Users/cathy/coding/bugs2025/USDA-Auburn-Su25/Exploration/Cole/probesplitter/gooddata_edited"
    probes = []
    ...
    with ThreadPoolExecutor() as executor:
        futures = [executor.submit(read_file, path, save_dir) for path in file_paths]
